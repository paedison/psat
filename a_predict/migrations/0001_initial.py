# Generated by Django 5.0.3 on 2024-07-13 11:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_exam_choices, default='행시', max_length=2, verbose_name='시험')),
            ...
            options={
                'verbose_name': 'PSAT 성적예측 [5] 답안개수',
                'verbose_name_plural': 'PSAT 성적예측 [5] 답안개수',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_exam_choices, default='행시', max_length=2, verbose_name='시험')),
                ('unit', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_unit_choices, default='5급공채', max_length=20, verbose_name='모집단위')),
                ('name', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_department_choices, default='일반행정', max_length=40, verbose_name='직렬')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'PSAT 성적예측 [6] 시험장소',
                'verbose_name_plural': 'PSAT 성적예측 [6] 시험장소',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField()),
                ('exam', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_exam_choices, default='행시', max_length=2, verbose_name='시험')),
                ('name', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_unit_choices, default='5급공채', max_length=20, verbose_name='모집단위')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_exam_choices, default='행시', max_length=2, verbose_name='시험')),
                ('unit', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_unit_choices, default='5급공채', max_length=20, verbose_name='모집단위')),
                ('department', models.CharField(choices=a_predict.models.base_settings.ChoiceMethod.psat_department_choices, default='일반행정', max_length=40, verbose_name='직렬')),
