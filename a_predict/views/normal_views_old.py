...
class IndexView(
    ...
    template_name = 'a_predict/normal/predict_index.html'
...
class IndexTestView(IndexView):
    template_name = 'a_predict/normal/predict_index_test.html'


class UpdateInfoAnswer(IndexView):
    """답안 제출 현황 업데이트"""
    template_name = 'a_predict/normal/snippets/update_info_answer.html'
...
class UpdateSheetScore(IndexView):
    """성적 예측 I [전체 데이터] 업데이트"""
    template_name = 'a_predict/normal/snippets/update_sheet_score.html'
...
class UpdateSheetAnswerPredict(IndexView):
    """예상 정답 업데이트"""
    template_name = 'a_predict/normal/snippets/update_sheet_answer_predict.html'
...
class UpdateSheetAnswer(IndexView):
    """정답 확인 업데이트"""
    template_name = 'a_predict/normal/snippets/update_sheet_answer.html'
...
class StudentCreateDepartment(
    ...
    template_name = 'a_predict/normal/snippets/index_info_student.html#student_create_department'
...
class AnswerInputView(
    ...
    template_name = 'a_predict/normal/predict_answer_input.html'
...
class AnswerSubmitView(
    ...
    menu = 'score'
    template_name = 'a_predict/normal/predict_answer_input.html#scored_form'
...
class AnswerConfirmView(
    ...
    menu = 'score'
    template_name = 'a_predict/normal/snippets/predict_modal.html#score_confirmed'
