...
def get_df_for_catalog(exam_vars: PredictExamVars, data):
    ...
    for dt in data:
        ...
        for i in range(-1, subject_num - 1):
            ...
            rank_ratio_total = round(rank_total * 100 / participants_total, 1) if rank_total and participants_total else ''
            rank_ratio_department = round(rank_department * 100 / participants_department, 1) if rank_department and participants_department else ''
