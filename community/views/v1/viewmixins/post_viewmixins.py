...
from .base_viewmixins import CommunityModelVariableSet
from common.constants.icon_set import ConstantIconSet
from community.forms import PostForm  # Should Change Module
from community.models import Post  # Should Change Module


class PostViewMixIn(
    ConstantIconSet,
    CommunityModelVariableSet,
):
    """
    ...
    list_content_template = f'{folder}/post_list.html#list_content'  # PostListView
