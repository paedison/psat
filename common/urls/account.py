...
from ..views.account_view import login_modal_view, logout_modal_view

urlpatterns = [
    path('login/modal/', login_modal_view, name='account_login_modal'),
    path('logout/modal/', logout_modal_view, name='account_logout_modal'),
