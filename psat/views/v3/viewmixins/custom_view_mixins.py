...
class MemoViewMixIn(ConstantIconSet):
    ...
    def get_properties(self):
        ...
        self.problem_id = int(problem_id) if problem_id else None
...
class TagViewMixIn(ConstantIconSet):
    ...
    template_name = 'psat/v3/snippets/tag_container.html'
    ...
    def get_properties(self):
        ...
        self.my_tag = custom_models.Tag.objects.get(id=self.my_tag_id) if self.my_tag_id else None
