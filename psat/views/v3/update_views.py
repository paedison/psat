...
class CustomUpdateView(
    ...
    template_name = 'psat/v3/snippets/icon_container.html'
...
class RateModalView(vanilla.TemplateView):
    template_name = 'psat/v3/snippets/icon_container.html#rate_modal'
...
class SolveModalView(
    ...
    template_name = 'psat/v3/snippets/solve_container.html#answer_modal'
