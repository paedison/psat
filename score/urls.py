...
urlpatterns = [
    ...
    path('prime/', include('score.urls_module.prime_v3')),  # Prime score version 2.0
    ...
    path('prime/admin/', include('score.urls_module.prime_admin_v3')),  # Prime_admin score version 2.0
