...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        score_keys = ['score_eoneo', 'score_jaryo', 'score_sanghwang', 'score_psat', 'score_heonbeob']
        ...
        def get_score(student):
            eoneo_score = get_score_subject(student, '언어')
            jaryo_score = get_score_subject(student, '자료')
            sanghwang_score = get_score_subject(student, '상황')
            heonbeob_score = get_score_subject(student, '헌법')
