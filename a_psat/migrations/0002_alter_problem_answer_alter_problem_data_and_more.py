...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='problem',
            name='answer',
            field=models.IntegerField(choices=a_psat.models.problem_models.answer_choice, default=1, verbose_name='정답'),
        ),
        migrations.AlterField(
            model_name='problem',
            name='data',
        ...
        migrations.AlterField(
            model_name='problem',
            name='number',
            field=models.IntegerField(choices=a_psat.models.problem_models.number_choice, default=1, verbose_name='번호'),
        ),
        migrations.AlterField(
            model_name='problem',
            name='paper_type',
        ...
        migrations.AlterField(
            model_name='problem',
            name='year',
            field=models.IntegerField(choices=a_psat.models.problem_models.year_choice, default=2024, verbose_name='연도'),
        ),
        migrations.CreateModel(
            name='Psat',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.IntegerField(choices=a_psat.models.problem_models.year_choice, default=2024, verbose_name='연도')),
                ('exam', models.CharField(choices=a_psat.models.problem_models.exam_choice, default='행시', max_length=2, verbose_name='시험')),
